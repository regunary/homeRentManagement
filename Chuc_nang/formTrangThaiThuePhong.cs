...
{
    public partial class formTrangThaiThuePhong : Form
    {
        ...
        private void listKhach_MouseClick(object sender, EventArgs e)
        {
            ListViewItem item = listKhach.SelectedItems[0];
            string id = item.Text;
            formThongTinKhachHang frmInfo = new formThongTinKhachHang(id);
            frmInfo.Show();
        }
        ...
        private void formTrangThaiThuePhong_Load_1(object sender, EventArgs e)
        {
            Load_Data_TreeView1();
            Load_Data_TreeView2();
            Load_CB_KV();
