...
namespace QuanLyNhaTroMain.Chuc_nang
{
    public partial class formTraPhong : Form
    {
        ...
        private void load_khach_dau(string id)
        {
            ...
            int result = 0;
            bool ifSuccess = int.TryParse(sqlttt.Rows[0][4].ToString(), out result);
            if (ifSuccess)
            {
        ...
        private void btnTraPhong_Click(object sender, EventArgs e)
        {
            ...
            TraPhong tp = new TraPhong(id, makhach, maphong, ngaythue, ngaytra);
        ...
        private void formTraPhong_Load_1(object sender, EventArgs e)
        {
            Load_KV();
            Load_listPhong();
            dtNgaySinh.Value = DateTime.Today;
