...
namespace QuanLyNhaTroMain.QuanLy
{
    ...
    public partial class formQuanLyKhach : Form
    {
        Room data = new Room();
        ...
        private void formQuanLyKhach_Load(object sender, EventArgs e)
        {
            Load_CBKV();
        }

        private void dgvQLKhach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            clearall();
